<?php
  ...
  $captcha_post_data = http_build_query(array('secret' => '6LcD0_QUAAAAANMwjcsowX6nhgiXkAJElnUvh1of', 'response' => $_POST["g-recaptcha-response"]));//getenv('RECAPTCHA_SECRET_KEY')
  ...
  $mail->SMTPAuth = true;
  $mail->Username = "todos722@gmail.com";
  $mail->Password = "123qwe456";
  
  $mail->SMTPSecure = 'tls';
  $mail->Port = 587;
  
  $mail->setFrom($_POST['email'], $_POST['name']);
  $mail->addAddress("todos722@gmail.com");
